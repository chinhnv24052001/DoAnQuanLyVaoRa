...
@NgModule({
    providers: [
        ...
        ApiServiceProxies.CourceSafetyServiceProxy,
        ApiServiceProxies.EmployeesLearnedSafetyServiceProxy,
        ApiServiceProxies.TemEmployeesLearnedSafetyServiceProxy,
        ApiServiceProxies.RequestAssetBringServiceProxy,
        ApiServiceProxies.AssetInOutManamentServiceProxy,
        ApiServiceProxies.HistoryInOutServiceProxy,
        ApiServiceProxies.ReportServiceProxy,
        ApiServiceProxies.NoteTextServiceProxy,
