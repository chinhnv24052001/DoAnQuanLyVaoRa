...
import { RequestAssetBringServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class GlobalValidator {
  ...
  static identitySafatyVal(control: FormControl) {
    if (control.value === 1) {
      return {identitySafatyVal: true};
    }
    return null;
  }
