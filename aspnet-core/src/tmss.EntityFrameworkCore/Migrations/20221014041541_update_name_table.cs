...
{
    public partial class update_name_table : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AioRequestAssetInOut", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "AioRequestPeopleInOut",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AioRequestPeopleInOut", x => x.Id);
                });
        }
