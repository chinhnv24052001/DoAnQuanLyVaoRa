...
namespace tmss.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var Security = context.GetPermissionOrNull(AppPermissions.Security) ?? context.CreatePermission(AppPermissions.Security, L("Security"));
            var SharedDriectory = context.GetPermissionOrNull(AppPermissions.SharedDriectory) ?? context.CreatePermission(AppPermissions.SharedDriectory, L("SharedDriectory"));
            var Report = context.GetPermissionOrNull(AppPermissions.Report) ?? context.CreatePermission(AppPermissions.Report, L("Report"));
            var Request = context.GetPermissionOrNull(AppPermissions.Request) ?? context.CreatePermission(AppPermissions.Request, L("Request"));
            var SecurityInOut = pages.CreateChildPermission(AppPermissions.Security_InOut, L("SecurityInOut"));
        }
