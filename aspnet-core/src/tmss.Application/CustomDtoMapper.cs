...
namespace tmss
{
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
            ...
            configuration.CreateMap<AioAssetDto, AioRequestAsset>();
            configuration.CreateMap<RequestAssetBringSaveDto, AioRequest>();
            configuration.CreateMap<AioEmployeesDto, AioRequestPeople>();
        }
    }
}
