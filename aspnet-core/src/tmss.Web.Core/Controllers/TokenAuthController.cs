...
using tmss.Authentication.TwoFactor.Radius;
...
namespace tmss.Web.Controllers
{
    ...
    public class TokenAuthController : tmssControllerBase
    {
        ...
        private readonly RadiusTwoFactorAuthenticateSersvice _radiusTwoFactorAuthenticateSersvice;
        ...
        public TokenAuthController(
            ...
            RadiusTwoFactorAuthenticateSersvice radiusTwoFactorAuthenticateSersvice)
        {
            ...
            _radiusTwoFactorAuthenticateSersvice = radiusTwoFactorAuthenticateSersvice;
        }
                ...
                if (model.TwoFactorVerificationCode.IsNullOrEmpty())
                {
                    ...
                    _cacheManager
                        ...
                        .Set(
                            ...
                            new TwoFactorCodeCacheItem(await _radiusTwoFactorAuthenticateSersvice.SendCodeAsync(model.UserNameOrEmailAddress, model.Password))
                        );
        ...
        private async Task<string> TwoFactorAuthenticateAsync(User user, AuthenticateModel authenticateModel)
        {
            ...
            else if (await _radiusTwoFactorAuthenticateSersvice.ValidateCodeAsync(authenticateModel.UserNameOrEmailAddress, authenticateModel.TwoFactorVerificationCode, cachedCode.Code))
            {
                throw new UserFriendlyException(L("InvalidSecurityCode"));
            }
